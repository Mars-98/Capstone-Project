 ...
 //import { BALLS } from "../lib/Images"
 import {TileData} from "../lib/TileData"
 import Tile from "./Tile";
 const BASEBALL = require("../assets/baseball.png");
 ...
 const  VOLLEYBALL = require("../assets/volleyball.jpg");

 const BALLS = [BASEBALL, BASKETBALL, FOOTBALL, TENNIS, VOLLEYBALL]
